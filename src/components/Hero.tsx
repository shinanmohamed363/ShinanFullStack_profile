      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        <div className="space-y-8">
          ...
          <div className="space-y-4">
            ...
            {/* Name */}
            <h2 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-gradient font-poppins animate-fadeInUp" style={{animationDelay: '0.2s'}}>
              Najimudeen Sanan
            </h2>
            
            {/* Typing Animation Role */}
            <div className="h-20 flex items-center justify-center">
              <h3 className="text-2xl sm:text-3xl lg:text-4xl font-semibold text-white font-inter min-h-[3rem]">
                {displayText}
                <span className={`inline-block w-1 h-8 bg-electric-cyan ml-1 ${showCursor ? 'opacity-100' : 'opacity-0'} transition-opacity`}></span>
              </h3>
            </div>

            {/* Subtitle */}
            <p className="text-lg sm:text-xl text-light-gray max-w-3xl mx-auto animate-fadeInUp" style={{animationDelay: '0.6s'}}>
              2.8+ Years Experience Building Scalable Solutions • Expert in MERN Stack, Python & AI/ML
            </p>
          </div>

          {/* Stats */}
          <div className="flex flex-wrap justify-center gap-8 mt-12 animate-fadeInUp" style={{animationDelay: '0.8s'}}>
            <div className="text-center">
              <div className="text-3xl font-bold text-gradient-green">2.8+</div>
              <div className="text-light-gray text-sm">Years Experience</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-gradient-green">15+</div>
              <div className="text-light-gray text-sm">Projects Delivered</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-gradient-green">99.9%</div>
              <div className="text-light-gray text-sm">Uptime</div>
            </div>
          </div>

          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row gap-6 justify-center mt-12 animate-fadeInUp" style={{animationDelay: '1s'}}>
            <button
          ...
          {/* Tech Stack Icons */}
          <div className="flex flex-wrap justify-center gap-6 mt-16 animate-fadeInUp" style={{animationDelay: '1.2s'}}>
            {techIcons.map((tech, index) => (
              <div
                key={tech.name}
                className="glass rounded-full w-16 h-16 flex items-center justify-center hover-glow cursor-pointer group"
